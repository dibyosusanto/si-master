...
@section('content')
    <div class="card my-4">
        <form action="{{ route('pengurus.update_infaq_web', $infaq_web->id_infaq) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="card-footer text-right text-light">
                <a class="btn btn-outline-primary" href="{{ route('pengurus.infaq_web_all') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali </a>
