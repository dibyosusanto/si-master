...
@section('content')    
    <div class="mt-4">
        <form action="{{ route('admin.update_pengumuman', $announcement->id_announcement) }}" method="post">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                <label class="font-weight-bold">Status Publish</label>
            ...
            <div class="form-group text-right">
                <a href="{{ route('admin.list_pengumuman') }}" class="btn btn-outline-primary"> <i class="fas fa-arrow-left"></i> Kembali</a>
