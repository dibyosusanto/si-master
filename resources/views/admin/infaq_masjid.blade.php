...
@section('content')
    <div class="my-4">
    <select name="masjid" id="masjid" class="form-control input-lg dynamic" data-dependent="jamaah">
        @foreach($masjids as $masjid)
            <option value="{{ $masjid->id_masjid }}"> {{ $masjid->nama_masjid }} </option>
        @endforeach
    </select>
    <select name="jamaah" id="jamaah" class="form-control input-lg dynamic">
        @foreach($list_jamaah as $jamaah)
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-info btn-sm" href="{{ route('admin.detail_infaq_masjid', $infaq_masjid->id_infaq) }}"><i class="fa fa-info-circle"></i>Detail</a>
                        <a class="btn btn-info btn-sm" href="{{ route('admin.edit_infaq_masjid', $infaq_masjid->id_infaq) }}"> <i class="fas fa-pen"></i> Edit</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('admin.input_infaq') }}" method="post">
                            @csrf
                            <div class="form-row">
    ...
    <!-- Modal Delete-->
    <form action="{{ route('admin.delete_infaq_masjid', $infaq_masjid->id_infaq ?? '') }}" method="post">
        @csrf
        @method('DELETE')
